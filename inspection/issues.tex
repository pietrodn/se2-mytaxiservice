...
\subsubsection{dump()}
The main problem of this function is it does nothing. Actions are replaced with comments which shortly explain what should be done.
\begin{enumerate}
	\item \checklist{13} Line length exceeded 80 characters at \codeline{1968} with 86 characters and at \codeline{1981} with 94 characters 
