...
\begin{enumerate}
    ...
    \item \checklist{18} The JavaDoc is too generic and some private methods are not documented well, for example the parameters given to the methods are not explain in the comments at \codelines{789}{791} , \codelines{860}{861}. %TODO check methods
