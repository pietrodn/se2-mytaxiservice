...
\begin{enumerate}
    ...
    \item \checklist{44} Brutish programming at (\codeline{1858}, \codeline{1925}).
...
\begin{enumerate}
    ...
    \item \checlist{27} All the if statements are identical to the ones in the method \texttt{\footnotesize synchronized void reUse()} at \codeline{2145}.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \checklist{53} At \codelines{222} the catch of the exception executes the \texttt{exc.printStackTrace();} istruction; printing all the stackTrace is not a very appropriate action.
\end{enumerate}
