...
\begin{tabular}{l p{0.7\textwidth}}
    ...
    \hline
    \textbf{Input Specification} & Typical call to JPI via entities mapped with tables in the Database tier.\\
    \hline
    \textbf{Output Specification} & The Database tier shall respond accordingly to the API specification. It must also react in the right way whether the requests are made correctly or if they comes from unauthorized sources that are trying to access the data.\\
    \hline
    \textbf{Environmental Needs} & Complete implementation of the Business tier, Java Persistence API, Test Database \\
    \hline
    \textbf{Test Description} & The response will be compared with the expected output.\\
    \hline
...
\begin{tabular}{l p{0.7\textwidth}}
    ...
    \hline
    \hline
    \textbf{Output Specification} & Correct results picked up\\
    \hline
    \textbf{Environmental Needs} & Glassfish server, Test Database \\
    \hline
    \textbf{Test Description} & The purpose of the test is to check that the right methods are called and the well working of queries to do typical actions like insert or select tuples.  \\
    \hline
    \textbf{Testing Method} & Automated with jUnit \\
    \hline
\end{tabular}
