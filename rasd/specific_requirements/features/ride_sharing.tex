...
In the first case the system informs the owner of the ride. The new passenger and eventually his crowd have to go to the meeting point with the owner of the ride in time. If their are not able to do that the taxi does not wait for them.
