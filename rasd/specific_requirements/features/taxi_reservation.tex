...
Event Flow & \begin{enumerate}
	...
	\item The passenger chooses the origin and destination addresses, the number of seats, and the time of pick-up.
...
\begin{enumerate}
	...
	\item The system asks the passenger the number of seats required in the taxi.
